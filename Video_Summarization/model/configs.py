...
save_dir = Path('.../CA-SUM-360/Summaries/exp1')
...
class Config(object):
    ...
    def set_dataset_dir(self, reg_factor=0.6, video_type='360VideoSumm'):
        ...
        :param str video_type: The Dataset being used, 360VideoSumm.
        """
...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--video_type', type=str, default='360VideoSumm', help='Dataset to be used')

    # Model
    parser.add_argument('--input_size', type=int, default=1024, help='Feature size expected in the input')
    parser.add_argument('--block_size', type=int, default=20, help="Size of blocks used inside the attention matrix")
    ...
    parser.add_argument('--batch_size', type=int, default=80, help='Size of each batch in training')
