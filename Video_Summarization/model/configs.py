...
save_dir = Path('/home/apostolid/data/Summaries/CA-SUM-TransMIXR/exp4')
...
class Config(object):
    ...
    def set_dataset_dir(self, reg_factor=0.6, video_type='TransMIXR'):
...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--video_type', type=str, default='TransMIXR', help='Dataset to be used')
