...
if __name__ == "__main__":
    ...
    parser.add_argument('--video_input_type', type=str,default='erp',help='erp if the input path contains erp videos, 360 if the input path contains 360 videos')
    parser.add_argument('--input_video_path', type=str, default=r'..Path_to_ERP_videos', help='Path to the input videos path')
    parser.add_argument('--output_folder', type=str,default=r'data\VR-EyeTracking\erp_frames\frames', help='Folder to save extracted frames')
